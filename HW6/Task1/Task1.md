...
**Выводы:**
1. Из-за негладкости подынтегральной функции классический теоретический порядок O(h^4) для метода Симпсона снижается и в численных экспериментах примерно $p_{eff} \approx 2-3$.
...
3. При больших N наблюдается граница, обусловленная машинной погрешностью - дальнейшее увеличение N не приведёт к заметному снижению абсолютной ошибки (шаг становится очень маленьким, все вычисления начинают работать в зоне, где разности практически не отличаются в пределах машинной точности - часть значащих цифр просто теряется.).